...
export class DiagnosisService {
  ...
  diagnosisList = [
    ...
    new DiagnosisDescription("Osteoarthristis","Osteoarthritis is the most common form of arthritis, affecting millions of people worldwide. It occurs when the protective cartilage that cushions the ends of your bones wears down over time."),
    new DiagnosisDescription("(vertigo) Paroymsal  Positional Vertigo","Benign paroxysmal positional vertigo (BPPV) is one of the most common causes of vertigo — the sudden sensation that you're spinning or that the inside of your head is spinning. Benign paroxysmal positional vertigo causes brief episodes of mild to intense dizziness.")
    ,
    ...
    new DiagnosisDescription("Impetigo","Impetigo (im-puh-TIE-go) is a common and highly contagious skin infection that mainly affects infants and children. Impetigo usually appears as red sores on the face, especially around a child's nose and mouth, and on hands and feet. The sores burst and develop honey-colored crusts."),
    ...
    new DiagnosisDescription("Chicken pox","Chickenpox is a highly contagious disease caused by the varicella-zoster virus (VZV). It can cause an itchy, blister-like rash. The rash first appears on the chest, back, and face, and then spreads over the entire body, causing between 250 and 500 itchy blisters."),
    ...
    [
      ...
      new DiagnosisPrecaution("Osteoarthristis",["acetaminophen","consult nearest hospital","follow up","salt baths"]),
      new DiagnosisPrecaution("(vertigo) Paroymsal  Positional Vertigo",["lie down","avoid sudden change in body","avoid abrupt head movment","relax"]),
      ...
      new DiagnosisPrecaution("Dimorphic hemmorhoids(piles)",["avoid fatty spicy food","consume witch hazel","warm bath with epsom salt","consume alovera juice"]),
